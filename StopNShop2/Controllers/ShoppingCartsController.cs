...
namespace StopNShop2.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShoppingCartID,Quantity")] ShoppingCart shoppingCart)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit(int id, [Bind("ShoppingCartID,Quantity")] ShoppingCart shoppingCart)
        {
